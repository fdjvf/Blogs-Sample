...
namespace Blogs.Core.Migrations
{
    ...
    [Migration("20210619222809_InitalMigration")]
            ...
            modelBuilder.Entity("Blogs.Core.Model.AuthToken", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("83e763e7-42b6-4898-849e-0aa4a32d1200"),
                            ExpirationDate = new DateTime(2021, 9, 19, 17, 28, 9, 268, DateTimeKind.Local).AddTicks(6025),
                            Token = "skzUF6rtAW",
